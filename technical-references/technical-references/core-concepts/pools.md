...
Whenever a trade occurs, a 0.90% fee is charged to the transaction sender. 0.30% of this fee is distributed _pro-rata_ to all LPs in the pool upon completion of the trade.
...
* [Understanding Returns](../advanced-topics/understanding-returns.md)
* [Fees](../advanced-topics/fee-structure-on-baptswap.md)

## Why pools?

Baptswap is unique in that it doesn’t use an order book to derive the price of an asset or to match buyers and sellers of tokens. Instead, Baptswap uses what are called Liquidity Pools.
